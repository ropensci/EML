...
setClass('ListOfdescription', contains = 'list')
setClass('ListOfannotation', contains = 'list')
setClass('eml:array', slots = c('dataType' = 'xml_attribute', 'errorValues' = 'xml_attribute', 'errorBasis' = 'xml_attribute', 'minValues' = 'xml_attribute', 'maxValues' = 'xml_attribute', 'units' = 'xml_attribute', 'delimiter' = 'xml_attribute', 'size' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('scalar', slots = c('dataType' = 'xml_attribute', 'errorValue' = 'xml_attribute', 'errorBasis' = 'xml_attribute', 'minValue' = 'xml_attribute', 'maxValue' = 'xml_attribute', 'units' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('eml:matrix', slots = c('dataType' = 'xml_attribute', 'delimiter' = 'xml_attribute', 'rows' = 'xml_attribute', 'columns' = 'xml_attribute', 'units' = 'xml_attribute', 'matrixType' = 'xml_attribute', 'errorValues' = 'xml_attribute', 'errorBasis' = 'xml_attribute', 'minValues' = 'xml_attribute', 'maxValues' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
...
setClass('alternative', slots = c('type' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
...
setClass('metadata', slots = c('name' = 'xml_attribute', 'content' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
...
setClass('coordinate2Type', contains = c('xs:string')) ## B
setClass('coordinate3Type', contains = c('xs:string')) ## B
setClass('dataTypeType', contains = c('xs:string')) ## B
setClass('sizeType', contains = c('xs:positiveInteger')) ## B
setClass('delimiterType', contains = c('xs:string')) ## B
...
setClass('idType', contains = c('xs:string')) ## B
setClass('errorBasisType', contains = c('xs:string')) ## B
setClass('maxType', contains = c('xs:string')) ## B
setClass('minType', contains = c('xs:string')) ## B
setClass('namespaceRefType', contains = c('xs:string')) ## B
setClass('refType', contains = c('idType')) ## B
setClass('metadataType', contains = c('xs:string')) ## B
setClass('dimensionType', contains = c('xs:string')) ## B
setClass('unitsType', contains = c('xs:string')) ## B
...
setClass('ListOfsubscript', contains = 'list')
setClass('ListOfsuperscript', contains = 'list')
setClass('TextType', slots = c('section' = 'ListOfsection', 'para' = 'ListOfpara'), contains = c('character', 'eml-2.1.1')) ## A
setClass('emphasis', slots = c('value' = 'ListOfvalue'), contains = c('character', 'eml-2.1.1')) ## A
...
setClass('ParagraphType', slots = c('value' = 'ListOfvalue', 'itemizedlist' = 'ListOfitemizedlist', 'orderedlist' = 'ListOforderedlist', 'emphasis' = 'ListOfemphasis', 'subscript' = 'ListOfsubscript', 'superscript' = 'ListOfsuperscript', 'literalLayout' = 'ListOfliteralLayout', 'ulink' = 'ListOfulink'), contains = c('character', 'eml-2.1.1')) ## A
setClass('SectionType', slots = c('para' = 'ListOfpara', 'section' = 'ListOfsection', 'title' = 'i18nString'), contains = c('eml-2.1.1')) ## A
...
setClass('SubSuperScriptType', slots = c('value' = 'ListOfvalue', 'subscript' = 'ListOfsubscript', 'superscript' = 'ListOfsuperscript'), contains = c('character', 'eml-2.1.1')) ## A
setClass('text', contains = c('TextType')) ## B
setClass('section', contains = c('SectionType')) ## B
setClass('para', contains = c('ParagraphType')) ## B
setClass('value', contains = c('i18nString')) ## B
...
setClass('value', contains = c('i18nString')) ## B
setClass('citetitle', contains = c('i18nString')) ## B
setClass('title', contains = c('i18nString')) ## B
setClass('para', contains = c('ParagraphType')) ## B
setClass('section', contains = c('SectionType')) ## B
setClass('para', contains = c('ParagraphType')) ## B
setClass('itemizedlist', contains = c('ListType')) ## B
...
setClass('subscript', contains = c('SubSuperScriptType')) ## B
setClass('superscript', contains = c('SubSuperScriptType')) ## B
setClass('i18nString', contains = c('xs:string')) ## B


#####  inst/xsd/eml-documentation.xsd  ####


setClass('moduleDocs', slots = c('moduleName' = 'xs:string', 'moduleDescription' = 'TextType', 'recommendedUsage' = 'xs:string', 'standAlone' = 'xs:string'), contains = c('eml-2.1.1')) ## A
setClass('moduleName', contains = c('xs:string')) ## B
setClass('moduleDescription', contains = c('TextType')) ## B
setClass('recommendedUsage', contains = c('xs:string')) ## B
setClass('standAlone', contains = c('xs:string')) ## B
setClass('tooltip', contains = c('xs:string')) ## B
setClass('summary', contains = c('xs:string')) ## B
setClass('description', contains = c('TextType')) ## B
setClass('example', contains = c('TextType')) ## B
setClass('lineage', contains = c('xs:string')) ## B
setClass('module', contains = c('xs:string')) ## B
...
setClass('LengthUnitType', contains = c('xs:string')) ## B
setClass('MassUnitType', contains = c('xs:string')) ## B
setClass('otherUnitType', contains = c('xs:string')) ## B
setClass('angleUnitType', contains = c('xs:string')) ## B
...
setClass('phone', slots = c('phonetype' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('userId', slots = c('directory' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('ResponsibleParty', slots = c('individualName' = 'ListOfindividualName', 'organizationName' = 'ListOforganizationName', 'positionName' = 'ListOfpositionName', 'address' = 'ListOfaddress', 'phone' = 'ListOfphone', 'electronicMailAddress' = 'ListOfelectronicMailAddress', 'onlineUrl' = 'ListOfonlineUrl', 'userId' = 'ListOfuserId', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('Person', slots = c('salutation' = 'ListOfsalutation', 'givenName' = 'ListOfgivenName', 'surName' = 'character'), contains = c('eml-2.1.1')) ## A
setClass('Address', slots = c('deliveryPoint' = 'ListOfdeliveryPoint', 'city' = 'character', 'administrativeArea' = 'character', 'postalCode' = 'character', 'country' = 'character', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('electronicMailAddress', contains = c('i18nNonEmptyStringType')) ## B
setClass('onlineUrl', contains = c('xs:anyURI')) ## B
setClass('individualName', contains = c('Person')) ## B
setClass('organizationName', contains = c('i18nNonEmptyStringType')) ## B
setClass('positionName', contains = c('i18nNonEmptyStringType')) ## B
setClass('salutation', contains = c('i18nNonEmptyStringType')) ## B
setClass('givenName', contains = c('i18nNonEmptyStringType')) ## B
setClass('surName', contains = c('i18nNonEmptyStringType')) ## B
setClass('deliveryPoint', contains = c('i18nNonEmptyStringType')) ## B
setClass('city', contains = c('i18nNonEmptyStringType')) ## B
setClass('administrativeArea', contains = c('i18nNonEmptyStringType')) ## B
setClass('postalCode', contains = c('i18nNonEmptyStringType')) ## B
setClass('country', contains = c('i18nNonEmptyStringType')) ## B
...
setClass('ListOfvalue', contains = 'list')
setClass('alternateIdentifier', slots = c('system' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('associatedParty', slots = c('role' = 'RoleType'), contains = c('ResponsibleParty', 'eml-2.1.1')) ## A
setClass('keyword', slots = c('keywordType' = 'xml_attribute'), contains = c('character', 'i18nNonEmptyStringType', 'eml-2.1.1')) ## A
...
setClass('references', slots = c('system' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('ReferencesGroup', slots = c('references' = 'character'), contains = c('eml-2.1.1')) ## A
setClass('DistributionType', slots = c('online' = 'OnlineType', 'offline' = 'OfflineType', 'inline' = 'InlineType', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('schemeName', slots = c('system' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('parameterDefinition', slots = c('name' = 'character', 'definition' = 'character', 'defaultValue' = 'character'), contains = c('eml-2.1.1')) ## A
setClass('ConnectionDefinitionType', slots = c('schemeName' = 'xs:string', 'description' = 'TextType', 'parameterDefinition' = 'ListOfparameterDefinition', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('OnlineType', slots = c('url' = 'UrlType', 'connection' = 'ConnectionType', 'connectionDefinition' = 'ConnectionDefinitionType', 'onlineDescription' = 'character'), contains = c('eml-2.1.1')) ## A
...
setClass('ConnectionType', slots = c('connectionDefinition' = 'ConnectionDefinitionType', 'parameter' = 'ListOfparameter', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('i18nNonEmptyStringType', slots = c('value' = 'ListOfvalue'), contains = c('character', 'eml-2.1.1')) ## A
setClass('KeyTypeCode', contains = c('xs:string')) ## B
setClass('yearDate', contains = c('character')) ## B
setClass('IDType', contains = c('character')) ## B
setClass('SystemType', contains = c('character')) ## B
setClass('ScopeType', contains = c('xs:string')) ## B
setClass('FunctionType', contains = c('xs:string')) ## B
setClass('NonEmptyStringType', contains = c('xs:string')) ## B
setClass('shortName', contains = c('NonEmptyStringType')) ## B
setClass('title', contains = c('i18nNonEmptyStringType')) ## B
...
setClass('eml:language', contains = c('i18nNonEmptyStringType')) ## B
setClass('series', contains = c('NonEmptyStringType')) ## B
setClass('abstract', contains = c('TextType')) ## B
setClass('keywordThesaurus', contains = c('NonEmptyStringType')) ## B
...
setClass('description', contains = c('TextType')) ## B
setClass('eml:name', contains = c('NonEmptyStringType')) ## B
setClass('definition', contains = c('NonEmptyStringType')) ## B
setClass('defaultValue', contains = c('NonEmptyStringType')) ## B
setClass('InlineType', contains='character')
setClass('mediumName', contains = c('NonEmptyStringType')) ## B
setClass('mediumDensity', contains = c('NonEmptyStringType')) ## B
setClass('mediumDensityUnits', contains = c('NonEmptyStringType')) ## B
setClass('mediumVolume', contains = c('NonEmptyStringType')) ## B
setClass('mediumFormat', contains = c('NonEmptyStringType')) ## B
setClass('mediumNote', contains = c('NonEmptyStringType')) ## B
setClass('onlineDescription', contains = c('i18nNonEmptyStringType')) ## B
...
setClass('connectionDefinition', contains = c('ConnectionDefinitionType')) ## B
setClass('eml:name', contains = c('NonEmptyStringType')) ## B
setClass('value', contains = c('NonEmptyStringType')) ## B
setClass('value', contains = c('NonEmptyStringType')) ## B
...
setClass('SpatialReferenceType', slots = c('horizCoordSysName' = 'character', 'horizCoordSysDef' = 'horizCoordSysType', 'vertCoordSys' = 'character', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('lengthUnits', contains = c('xs:string')) ## B
setClass('angleUnits', contains = c('xs:string')) ## B
setClass('horizCoordSysDef', contains = c('horizCoordSysType')) ## B
setClass('spatialReference', contains = c('SpatialReferenceType')) ## B
setClass('altitudeDatumName', contains = c('NonEmptyStringType')) ## B
setClass('altitudeResolution', contains = c('NonEmptyStringType')) ## B
setClass('altitudeDistanceUnits', contains = c('NonEmptyStringType')) ## B
setClass('altitudeEncodingMethod', contains = c('NonEmptyStringType')) ## B
setClass('depthDatumName', contains = c('NonEmptyStringType')) ## B
setClass('depthResolution', contains = c('NonEmptyStringType')) ## B
setClass('depthDistanceUnits', contains = c('NonEmptyStringType')) ## B
setClass('depthEncodingMethod', contains = c('NonEmptyStringType')) ## B
setClass('horizCoordSysName', contains = c('xs:string')) ## B
setClass('horizCoordSysDef', contains = c('horizCoordSysType')) ## B
...
setClass('AccessType', slots = c('allow' = 'ListOfallow', 'deny' = 'ListOfdeny', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute', 'order' = 'xml_attribute', 'authSystem' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('principal', contains = c('NonEmptyStringType')) ## B
...
setClass('ForeignKeyGroup', slots = c('key' = 'key', 'entityReference' = 'character', 'relationshipType' = 'character', 'cardinality' = 'cardinality'), contains = c('ConstraintBaseGroup', 'eml-2.1.1')) ## A
setClass('key', slots = c('attributeReference' = 'ListOfattributeReference'), contains = c('eml-2.1.1')) ## A
setClass('primaryKey', slots = c('key' = 'character'), contains = c('ConstraintBaseGroup', 'eml-2.1.1')) ## A
setClass('key', slots = c('attributeReference' = 'ListOfattributeReference'), contains = c('eml-2.1.1')) ## A
setClass('uniqueKey', slots = c('key' = 'character'), contains = c('ConstraintBaseGroup', 'eml-2.1.1')) ## A
setClass('checkConstraint', slots = c('checkCondition' = 'character', 'language' = 'xml_attribute'), contains = c('ConstraintBaseGroup', 'eml-2.1.1')) ## A
setClass('referencedKey', slots = c('attributeReference' = 'ListOfattributeReference'), contains = c('eml-2.1.1')) ## A
setClass('joinCondition', slots = c('referencedKey' = 'character'), contains = c('ForeignKeyGroup', 'eml-2.1.1')) ## A
setClass('key', slots = c('attributeReference' = 'ListOfattributeReference'), contains = c('eml-2.1.1')) ## A
setClass('notNullConstraint', slots = c('key' = 'character'), contains = c('ConstraintBaseGroup', 'eml-2.1.1')) ## A
...
setClass('constraintName', contains = c('NonEmptyStringType')) ## B
setClass('constraintDescription', contains = c('character')) ## B
setClass('attributeReference', contains = c('NonEmptyStringType')) ## B
setClass('entityReference', contains = c('NonEmptyStringType')) ## B
setClass('relationshipType', contains = c('xs:string')) ## B
setClass('parentOccurences', contains = c('xs:integer')) ## B
setClass('childOccurences', contains = c('CardinalityChildOccurancesType')) ## B
setClass('attributeReference', contains = c('NonEmptyStringType')) ## B
setClass('attributeReference', contains = c('NonEmptyStringType')) ## B
setClass('checkCondition', contains = c('NonEmptyStringType')) ## B
setClass('foreignKey', contains = c('ForeignKeyGroup')) ## B
setClass('attributeReference', contains = c('NonEmptyStringType')) ## B
setClass('attributeReference', contains = c('NonEmptyStringType')) ## B
...
setClass('CitationType', slots = c('article' = 'Article', 'book' = 'Book', 'chapter' = 'Chapter', 'editedBook' = 'Book', 'manuscript' = 'Manuscript', 'report' = 'Report', 'thesis' = 'Thesis', 'conferenceProceedings' = 'ConferenceProceedings', 'personalCommunication' = 'PersonalCommunication', 'map' = 'Map', 'generic' = 'Generic', 'audioVisual' = 'AudioVisual', 'presentation' = 'Presentation', 'contact' = 'ListOfcontact', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ResourceGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('Generic', slots = c('ISBN' = 'character', 'ISSN' = 'character', 'publisher' = 'ResponsibleParty', 'publicationPlace' = 'character', 'referenceType' = 'character', 'volume' = 'character', 'numberOfVolumes' = 'character', 'totalPages' = 'character', 'totalFigures' = 'character', 'totalTables' = 'character', 'edition' = 'character', 'originalPublication' = 'character', 'reprintEdition' = 'character', 'reviewedItem' = 'character'), contains = c('eml-2.1.1')) ## A
...
setClass('journal', contains = c('NonEmptyStringType')) ## B
setClass('volume', contains = c('NonEmptyStringType')) ## B
setClass('issue', contains = c('NonEmptyStringType')) ## B
setClass('pageRange', contains = c('NonEmptyStringType')) ## B
setClass('publisher', contains = c('ResponsibleParty')) ## B
setClass('publicationPlace', contains = c('NonEmptyStringType')) ## B
setClass('ISSN', contains = c('NonEmptyStringType')) ## B
setClass('publisher', contains = c('ResponsibleParty')) ## B
setClass('publicationPlace', contains = c('NonEmptyStringType')) ## B
setClass('edition', contains = c('NonEmptyStringType')) ## B
setClass('volume', contains = c('NonEmptyStringType')) ## B
setClass('numberOfVolumes', contains = c('NonEmptyStringType')) ## B
setClass('totalPages', contains = c('NonEmptyStringType')) ## B
setClass('totalFigures', contains = c('NonEmptyStringType')) ## B
setClass('totalTables', contains = c('NonEmptyStringType')) ## B
setClass('ISBN', contains = c('NonEmptyStringType')) ## B
setClass('chapterNumber', contains = c('NonEmptyStringType')) ## B
setClass('editor', contains = c('ResponsibleParty')) ## B
setClass('bookTitle', contains = c('NonEmptyStringType')) ## B
setClass('pageRange', contains = c('NonEmptyStringType')) ## B
setClass('conferenceName', contains = c('NonEmptyStringType')) ## B
setClass('conferenceDate', contains = c('NonEmptyStringType')) ## B
setClass('conferenceLocation', contains = c('Address')) ## B
setClass('institution', contains = c('ResponsibleParty')) ## B
setClass('totalPages', contains = c('NonEmptyStringType')) ## B
setClass('reportNumber', contains = c('NonEmptyStringType')) ## B
setClass('publisher', contains = c('ResponsibleParty')) ## B
setClass('publicationPlace', contains = c('NonEmptyStringType')) ## B
setClass('totalPages', contains = c('NonEmptyStringType')) ## B
setClass('publisher', contains = c('ResponsibleParty')) ## B
setClass('publicationPlace', contains = c('NonEmptyStringType')) ## B
setClass('communicationType', contains = c('NonEmptyStringType')) ## B
setClass('recipient', contains = c('ResponsibleParty')) ## B
setClass('publisher', contains = c('ResponsibleParty')) ## B
setClass('edition', contains = c('NonEmptyStringType')) ## B

setClass('scale', contains = c('NonEmptyStringType')) ## B
setClass('publisher', contains = c('ResponsibleParty')) ## B
setClass('publicationPlace', contains = c('NonEmptyStringType')) ## B
...
setClass('totalTables', contains = c('NonEmptyStringType')) ## B
setClass('edition', contains = c('NonEmptyStringType')) ## B
setClass('originalPublication', contains = c('NonEmptyStringType')) ## B
setClass('reprintEdition', contains = c('NonEmptyStringType')) ## B
setClass('reviewedItem', contains = c('NonEmptyStringType')) ## B
setClass('ISBN', contains = c('NonEmptyStringType')) ## B
setClass('ISSN', contains = c('NonEmptyStringType')) ## B
setClass('degree', contains = c('NonEmptyStringType')) ## B
setClass('institution', contains = c('ResponsibleParty')) ## B
setClass('totalPages', contains = c('NonEmptyStringType')) ## B
setClass('conferenceName', contains = c('NonEmptyStringType')) ## B
setClass('conferenceDate', contains = c('NonEmptyStringType')) ## B
...
setClass('Coverage', slots = c('geographicCoverage' = 'ListOfgeographicCoverage', 'temporalCoverage' = 'ListOftemporalCoverage', 'taxonomicCoverage' = 'ListOftaxonomicCoverage', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('rangeOfDates', slots = c('beginDate' = 'SingleDateTimeType', 'endDate' = 'SingleDateTimeType'), contains = c('eml-2.1.1')) ## A
setClass('TemporalCoverage', slots = c('singleDateTime' = 'ListOfsingleDateTime', 'rangeOfDates' = 'rangeOfDates', 'id' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('SingleDateTimeType', slots = c('calendarDate' = 'yearDate', 'time' = 'xs:time', 'alternativeTimeScale' = 'character'), contains = c('eml-2.1.1')) ## A
...
setClass('datasetGPolygonOuterGRing', slots = c('gRingPoint' = 'ListOfgRingPoint', 'gRing' = 'GRingType'), contains = c('eml-2.1.1')) ## A
...
setClass('GeographicCoverage', slots = c('geographicDescription' = 'character', 'boundingCoordinates' = 'boundingCoordinates', 'datasetGPolygon' = 'ListOfdatasetGPolygon', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('TaxonomicCoverage', slots = c('taxonomicSystem' = 'taxonomicSystem', 'generalTaxonomicCoverage' = 'character', 'taxonomicClassification' = 'ListOftaxonomicClassification', 'id' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('GRingType', contains = c('xs:string')) ## B
...
setClass('timeScaleName', contains = c('NonEmptyStringType')) ## B
setClass('timeScaleAgeEstimate', contains = c('NonEmptyStringType')) ## B
setClass('timeScaleAgeUncertainty', contains = c('NonEmptyStringType')) ## B
setClass('timeScaleAgeExplanation', contains = c('NonEmptyStringType')) ## B
...
setClass('geographicDescription', contains = c('NonEmptyStringType')) ## B
...
setClass('classificationSystemModifications', contains = c('NonEmptyStringType')) ## B
setClass('identificationReference', contains = c('CitationType')) ## B
setClass('identifierName', contains = c('ResponsibleParty')) ## B
setClass('taxonomicProcedures', contains = c('NonEmptyStringType')) ## B
setClass('taxonomicCompleteness', contains = c('NonEmptyStringType')) ## B
setClass('specimen', contains = c('NonEmptyStringType')) ## B
setClass('originator', contains = c('ResponsibleParty')) ## B
setClass('generalTaxonomicCoverage', contains = c('NonEmptyStringType')) ## B
setClass('taxonomicClassification', contains = c('TaxonomicClassificationType')) ## B
setClass('taxonRankName', contains = c('NonEmptyStringType')) ## B
setClass('taxonRankValue', contains = c('NonEmptyStringType')) ## B
setClass('commonName', contains = c('NonEmptyStringType')) ## B
setClass('taxonomicClassification', contains = c('TaxonomicClassificationType')) ## B
...
setClass('ListOfdistribution', contains = 'list')
setClass('size', slots = c('unit' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('authentication', slots = c('method' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
...
setClass('textDelimited', slots = c('fieldDelimiter' = 'xs:string', 'collapseDelimiters' = 'character', 'lineNumber' = 'xs:unsignedLong', 'quoteCharacter' = 'ListOfquoteCharacter', 'literalCharacter' = 'ListOfliteralCharacter'), contains = c('eml-2.1.1')) ## A
setClass('eml:complex', slots = c('textFixed' = 'ListOftextFixed', 'textDelimited' = 'ListOftextDelimited'), contains = c('eml-2.1.1')) ## A
setClass('textFormat', slots = c('simpleDelimited' = 'character', 'complex' = 'character', 'numHeaderLines' = 'xs:int', 'numFooterLines' = 'xs:int', 'recordDelimiter' = 'ListOfrecordDelimiter', 'physicalLineDelimiter' = 'ListOfphysicalLineDelimiter', 'numPhysicalLinesPerRecord' = 'xs:unsignedInt', 'maxRecordLength' = 'xs:unsignedLong', 'attributeOrientation' = 'character'), contains = c('eml-2.1.1')) ## A
...
setClass('PhysicalType', slots = c('compressionMethod' = 'ListOfcompressionMethod', 'encodingMethod' = 'ListOfencodingMethod', 'objectName' = 'character', 'size' = 'xs:string', 'authentication' = 'ListOfauthentication', 'characterEncoding' = 'character', 'dataFormat' = 'dataFormat', 'distribution' = 'ListOfdistribution', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('PhysicalDistributionType', slots = c('online' = 'PhysicalOnlineType', 'offline' = 'OfflineType', 'inline' = 'InlineType', 'access' = 'AccessType', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('PhysicalOnlineType', slots = c('url' = 'UrlType', 'connection' = 'ConnectionType', 'onlineDescription' = 'character'), contains = c('eml-2.1.1')) ## A
setClass('physical', contains = c('PhysicalType')) ## B
setClass('objectName', contains = c('NonEmptyStringType')) ## B
setClass('characterEncoding', contains = c('NonEmptyStringType')) ## B
setClass('numHeaderLines', contains = c('xs:int')) ## B
setClass('numFooterLines', contains = c('xs:int')) ## B
setClass('recordDelimiter', contains = c('xs:string')) ## B
setClass('physicalLineDelimiter', contains = c('xs:string')) ## B
setClass('numPhysicalLinesPerRecord', contains = c('xs:unsignedInt')) ## B
setClass('maxRecordLength', contains = c('xs:unsignedLong')) ## B
setClass('attributeOrientation', contains = c('xs:string')) ## B
setClass('fieldDelimiter', contains = c('xs:string')) ## B
setClass('collapseDelimiters', contains = c('xs:string')) ## B
setClass('quoteCharacter', contains = c('NonEmptyStringType')) ## B
setClass('literalCharacter', contains = c('NonEmptyStringType')) ## B
...
setClass('quoteCharacter', contains = c('NonEmptyStringType')) ## B
setClass('literalCharacter', contains = c('NonEmptyStringType')) ## B
setClass('formatName', contains = c('NonEmptyStringType')) ## B
setClass('formatVersion', contains = c('NonEmptyStringType')) ## B
setClass('citation', contains = c('CitationType')) ## B
setClass('rowColumnOrientation', contains = c('xs:string')) ## B
setClass('nbands', contains = c('xs:int')) ## B
setClass('layout', contains = c('NonEmptyStringType')) ## B
setClass('nbits', contains = c('xs:int')) ## B
setClass('byteorder', contains = c('NonEmptyStringType')) ## B
setClass('skipbytes', contains = c('NonEmptyStringType')) ## B
setClass('bandrowbytes', contains = c('NonEmptyStringType')) ## B
setClass('totalrowbytes', contains = c('NonEmptyStringType')) ## B
setClass('bandgapbytes', contains = c('NonEmptyStringType')) ## B
setClass('distribution', contains = c('PhysicalDistributionType')) ## B
setClass('compressionMethod', contains = c('NonEmptyStringType')) ## B
setClass('encodingMethod', contains = c('NonEmptyStringType')) ## B
setClass('access', contains = c('AccessType')) ## B
setClass('online', contains = c('PhysicalOnlineType')) ## B
setClass('offline', contains = c('OfflineType')) ## B
setClass('inline', contains='character')
setClass('onlineDescription', contains = c('NonEmptyStringType')) ## B
setClass('url', contains = c('UrlType')) ## B
setClass('connection', contains = c('ConnectionType')) ## B
...
setClass('descriptorValue', slots = c('name_or_id' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
...
setClass('SoftwareType', slots = c('licenseURL' = 'ListOflicenseURL', 'license' = 'ListOflicense', 'implementation' = 'ListOfimplementation', 'dependency' = 'ListOfdependency', 'version' = 'character', 'project' = 'ResearchProjectType', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ResourceGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
setClass('Action', contains = c('xs:string')) ## B
setClass('software', contains = c('SoftwareType')) ## B
setClass('action', contains = c('Action')) ## B
setClass('distribution', contains = c('PhysicalDistributionType')) ## B
setClass('size', contains = c('NonEmptyStringType')) ## B
setClass('LanguageValue', contains = c('NonEmptyStringType')) ## B
setClass('LanguageCodeStandard', contains = c('NonEmptyStringType')) ## B
setClass('operatingSystem', contains = c('NonEmptyStringType')) ## B
setClass('machineProcessor', contains = c('NonEmptyStringType')) ## B
setClass('virtualMachine', contains = c('NonEmptyStringType')) ## B
setClass('diskUsage', contains = c('NonEmptyStringType')) ## B
setClass('runtimeMemoryUsage', contains = c('NonEmptyStringType')) ## B
setClass('programmingLanguage', contains = c('NonEmptyStringType')) ## B
setClass('checksum', contains = c('NonEmptyStringType')) ## B
setClass('version', contains = c('NonEmptyStringType')) ## B
setClass('project', contains = c('ResearchProjectType')) ## B
setClass('licenseURL', contains = c('NonEmptyStringType')) ## B
setClass('license', contains = c('NonEmptyStringType')) ## B
...
setClass('ProtocolType', slots = c('proceduralStep' = 'ListOfproceduralStep', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ResourceGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('ProcedureStepType', slots = c('citation' = 'ListOfcitation', 'protocol' = 'ListOfprotocol', 'description' = 'TextType', 'instrumentation' = 'ListOfinstrumentation', 'software' = 'ListOfsoftware', 'subStep' = 'ListOfsubStep'), contains = c('eml-2.1.1')) ## A
...
setClass('instrumentation', contains = c('NonEmptyStringType')) ## B
setClass('software', contains = c('SoftwareType')) ## B
...
setClass('minimum', slots = c('exclusive' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('maximum', slots = c('exclusive' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
setClass('bounds', slots = c('minimum' = 'character', 'maximum' = 'character'), contains = c('eml-2.1.1')) ## A
setClass('BoundsDateGroup', slots = c('bounds' = 'ListOfbounds'), contains = c('eml-2.1.1')) ## A
setClass('AttributeListType', slots = c('attribute' = 'ListOfattribute', 'id' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('storageType', slots = c('typeSystem' = 'xml_attribute'), contains = c('xs:string', 'eml-2.1.1')) ## A
...
setClass('AttributeType', slots = c('attributeName' = 'character', 'attributeLabel' = 'ListOfattributeLabel', 'attributeDefinition' = 'character', 'storageType' = 'ListOfstorageType', 'measurementScale' = 'measurementScale', 'missingValueCode' = 'ListOfmissingValueCode', 'accuracy' = 'Accuracy', 'coverage' = 'Coverage', 'methods' = 'MethodsType', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('externalCodeSet', slots = c('citation' = 'ListOfcitation', 'codesetURL' = 'ListOfcodesetURL', 'codesetName' = 'character'), contains = c('eml-2.1.1')) ## A
...
setClass('NonNumericDomainType', slots = c('enumeratedDomain' = 'ListOfenumeratedDomain', 'textDomain' = 'ListOftextDomain', 'id' = 'xml_attribute'), contains = c('ReferencesGroup', 'eml-2.1.1')) ## A
setClass('NumericDomainType', slots = c('numberType' = 'NumberType', 'id' = 'xml_attribute'), contains = c('BoundsGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
setClass('DateTimeDomainType', slots = c('id' = 'xml_attribute'), contains = c('BoundsDateGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
setClass('NumberType', contains = c('xs:string')) ## B
setClass('attribute', contains = c('AttributeType')) ## B
setClass('attributeList', contains = c('AttributeListType')) ## B
setClass('attribute', contains = c('AttributeType')) ## B
setClass('attributeName', contains = c('NonEmptyStringType')) ## B
setClass('attributeLabel', contains = c('NonEmptyStringType')) ## B
setClass('attributeDefinition', contains = c('NonEmptyStringType')) ## B
...
setClass('precision', contains = c('PrecisionType')) ## B
setClass('numericDomain', contains = c('NumericDomainType')) ## B
setClass('formatString', contains = c('NonEmptyStringType')) ## B
setClass('dateTimePrecision', contains = c('NonEmptyStringType')) ## B
setClass('dateTimeDomain', contains = c('DateTimeDomainType')) ## B
setClass('code', contains = c('NonEmptyStringType')) ## B
setClass('codeExplanation', contains = c('NonEmptyStringType')) ## B
setClass('accuracy', contains = c('Accuracy')) ## B

setClass('methods', contains = c('MethodsType')) ## B
setClass('attributeAccuracyReport', contains = c('NonEmptyStringType')) ## B
setClass('attributeAccuracyValue', contains = c('NonEmptyStringType')) ## B
setClass('attributeAccuracyExplanation', contains = c('NonEmptyStringType')) ## B
setClass('standardUnit', contains = c('StandardUnitDictionary')) ## B
setClass('customUnit', contains = c('NonEmptyStringType')) ## B
setClass('PrecisionType', contains = c('xs:float')) ## B
setClass('code', contains = c('NonEmptyStringType')) ## B
setClass('definition', contains = c('NonEmptyStringType')) ## B
setClass('source', contains = c('NonEmptyStringType')) ## B
setClass('codesetName', contains = c('NonEmptyStringType')) ## B
setClass('citation', contains = c('CitationType')) ## B
setClass('codesetURL', contains = c('xs:anyURI')) ## B
setClass('entityReference', contains = c('NonEmptyStringType')) ## B
setClass('valueAttributeReference', contains = c('NonEmptyStringType')) ## B
setClass('definitionAttributeReference', contains = c('NonEmptyStringType')) ## B
setClass('orderAttributeReference', contains = c('NonEmptyStringType')) ## B
setClass('definition', contains = c('NonEmptyStringType')) ## B
setClass('pattern', contains = c('NonEmptyStringType')) ## B
setClass('source', contains = c('NonEmptyStringType')) ## B
...
setClass('OtherEntityType', slots = c('attributeList' = 'AttributeListType', 'constraint' = 'ListOfconstraint', 'entityType' = 'character', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('EntityGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
setClass('otherEntity', contains = c('OtherEntityType')) ## B
setClass('entityName', contains = c('NonEmptyStringType')) ## B
setClass('entityDescription', contains = c('NonEmptyStringType')) ## B
setClass('physical', contains = c('PhysicalType')) ## B
...
setClass('entityType', contains = c('NonEmptyStringType')) ## B
...
setClass('ListOfconstraint', contains = 'list')
setClass('DataTableType', slots = c('attributeList' = 'AttributeListType', 'constraint' = 'ListOfconstraint', 'caseSensitive' = 'character', 'numberOfRecords' = 'character', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('EntityGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
setClass('dataTable', contains = c('DataTableType')) ## B
setClass('attributeList', contains = c('AttributeListType')) ## B
setClass('constraint', contains = c('ConstraintType')) ## B
setClass('caseSensitive', contains = c('xs:string')) ## B
setClass('numberOfRecords', contains = c('NonEmptyStringType')) ## B
...
setClass('ListOfconstraint', contains = 'list')
setClass('ViewType', slots = c('attributeList' = 'AttributeListType', 'constraint' = 'ListOfconstraint', 'queryStatement' = 'character', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('EntityGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
setClass('view', contains = c('ViewType')) ## B
setClass('attributeList', contains = c('AttributeListType')) ## B
setClass('constraint', contains = c('ConstraintType')) ## B
setClass('queryStatement', contains = c('NonEmptyStringType')) ## B
...
setClass('ListOfconstraint', contains = 'list')
setClass('ListOfparameter', contains = 'list')
setClass('StoredProcedureType', slots = c('attributeList' = 'AttributeListType', 'constraint' = 'ListOfconstraint', 'parameter' = 'ListOfparameter', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('EntityGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('eml:name', contains = c('NonEmptyStringType')) ## B
setClass('domainDescription', contains = c('NonEmptyStringType')) ## B
...
setClass('SpatialVectorType', slots = c('attributeList' = 'AttributeListType', 'constraint' = 'ListOfconstraint', 'geometry' = 'ListOfgeometry', 'geometricObjectCount' = 'character', 'topologyLevel' = 'TopologyLevel', 'spatialReference' = 'SpatialReferenceType', 'horizontalAccuracy' = 'DataQuality', 'verticalAccuracy' = 'DataQuality', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('EntityGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('GeometryType', contains = c('xs:string')) ## B
setClass('TopologyLevel', contains = c('xs:string')) ## B
setClass('spatialVector', contains = c('SpatialVectorType')) ## B
setClass('attributeList', contains = c('AttributeListType')) ## B
setClass('constraint', contains = c('ConstraintType')) ## B
setClass('geometry', contains = c('GeometryType')) ## B
setClass('geometricObjectCount', contains = c('NonEmptyStringType')) ## B
...
setClass('accuracyReport', contains = c('NonEmptyStringType')) ## B
setClass('quantitativeAccuracyValue', contains = c('NonEmptyStringType')) ## B
setClass('quantitativeAccuracyMethod', contains = c('NonEmptyStringType')) ## B
...
setClass('quantitativeAccuracyReport', slots = c('quantitativeAccuracyValue' = 'character', 'quantitativeAccuracyMethod' = 'character'), contains = c('eml-2.1.1')) ## A
setClass('DataQuality', slots = c('accuracyReport' = 'character', 'quantitativeAccuracyReport' = 'ListOfquantitativeAccuracyReport'), contains = c('eml-2.1.1')) ## A
setClass('CellValueType', contains = c('xs:string')) ## B
setClass('ImagingConditionCode', contains = c('xs:string')) ## B
setClass('rasterOriginType', contains = c('xs:string')) ## B
setClass('CellGeometryType', contains = c('xs:string')) ## B
...
setClass('pointInPixel', contains = c('xs:string')) ## B
...
setClass('rows', contains = c('NonEmptyStringType')) ## B
setClass('columns', contains = c('NonEmptyStringType')) ## B
...
setClass('scaleFactor', contains = c('NonEmptyStringType')) ## B
setClass('offset', contains = c('NonEmptyStringType')) ## B
...
setClass('imageQualityCode', contains = c('NonEmptyStringType')) ## B
setClass('cloudCoverPercentage', contains = c('xs:float')) ## B
setClass('preProcessingTypeCode', contains = c('NonEmptyStringType')) ## B
...
setClass('sequenceIdentifier', contains = c('NonEmptyStringType')) ## B
...
setClass('DatasetType', slots = c('dataTable' = 'ListOfdataTable', 'spatialRaster' = 'ListOfspatialRaster', 'spatialVector' = 'ListOfspatialVector', 'storedProcedure' = 'ListOfstoredProcedure', 'view' = 'ListOfview', 'otherEntity' = 'ListOfotherEntity', 'purpose' = 'TextType', 'maintenance' = 'MaintenanceType', 'contact' = 'ListOfcontact', 'publisher' = 'ResponsibleParty', 'pubPlace' = 'character', 'methods' = 'MethodsType', 'project' = 'ResearchProjectType', 'id' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute'), contains = c('ResourceGroup', 'ReferencesGroup', 'eml-2.1.1')) ## A
...
setClass('MaintUpFreqType', contains = c('xs:string')) ## B
...
setClass('contact', contains = c('ResponsibleParty')) ## B
setClass('publisher', contains = c('ResponsibleParty')) ## B
setClass('pubPlace', contains = c('NonEmptyStringType')) ## B
setClass('methods', contains = c('MethodsType')) ## B
setClass('project', contains = c('ResearchProjectType')) ## B
setClass('dataTable', contains = c('DataTableType')) ## B
setClass('spatialRaster', contains = c('SpatialRasterType')) ## B
...
setClass('changeScope', contains = c('NonEmptyStringType')) ## B
setClass('oldValue', contains = c('NonEmptyStringType')) ## B
setClass('changeDate', contains = c('xs:date')) ## B
setClass('comment', contains = c('NonEmptyStringType')) ## B
...
setClass('eml', slots = c('dataset' = 'DatasetType', 'citation' = 'CitationType', 'software' = 'SoftwareType', 'protocol' = 'ProtocolType', 'access' = 'AccessType', 'additionalMetadata' = 'ListOfadditionalMetadata', 'packageId' = 'xml_attribute', 'system' = 'xml_attribute', 'scope' = 'xml_attribute', 'xml:lang' = 'xml_attribute'), contains = c('eml-2.1.1')) ## A
setClass('access', contains = c('AccessType')) ## B
setClass('describes', contains = c('NonEmptyStringType')) ## B
