...
setMethod(initialize, 'unitType', function(.Object, dimension = character(), id = character(), name = character()){
  slot(.Object, 'id') <- as(id, 'xml_attribute')
  slot(.Object, 'name') <- as(name, 'xml_attribute')
  slot(.Object, 'dimension') <- c_as(dimension, 'dimension')
  .Object
})
setMethod(initialize, 'unit', function(.Object, description = character(), 
  ...
  slot(.Object, 'standardUnit') <- as(standardUnit, 'StandardUnitDictionary')
...
setMethod(initialize, 'description', function(.Object, .Data = character(), section = character(), para = character(), lang = new('xml_attribute'), schemaLocation = new('xml_attribute'), slot_order = new('character')){
  slot(.Object, 'lang') <- as(lang, 'xml_attribute')
  slot(.Object, 'schemaLocation') <- as(schemaLocation, 'xml_attribute')
