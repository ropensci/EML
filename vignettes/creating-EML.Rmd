...
dataTable <- new("dataTable",
                 ...
                 entityName = as.character(physical@objectName),
...
```{r}
methods_file <- system.file("examples/hf205-methods.md", package = "EML")
...
Likewise this method cna be applied to a list of `person` objects.  Note that 
...
Of course, we can use the default constructor method (`new()`) to create any of these elements, instead of the 
