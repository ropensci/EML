...
%\VignetteIndexEntry{EML: One simple way to share your data}
-->
...
`EML` can automatically push our data to a variety of established repositories, as illustrated in this example. 

## 9. Licenses

We see by default `EML` has provided us with the liberal CC0 license for the data, consistent with major repositories such as Dryad.  Other options can be specified if needed.  
