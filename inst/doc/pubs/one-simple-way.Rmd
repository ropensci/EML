...
R has good null values in its use of `data.frames`, so we already have
these.  Better yet, we write out our choice of null value in the metadata.
...
mistakes are still possible, automated validation of the metadata
provided and
